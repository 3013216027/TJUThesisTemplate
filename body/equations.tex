...
\begin{subfigure}[b]{0.55\textwidth}
  \centering
  \fbox{\includegraphics[width=\textwidth]{latex}}
  \caption{由~\LaTeX~系统生成的行内公式}\label{fig:subfig:latex}
\end{subfigure}

\begin{subfigure}[b]{0.55\textwidth}
  \centering
  \fbox{\includegraphics[width=\textwidth]{word}}
  \caption{由~Word软件生成的~.doc~格式行内公式}\label{fig:subfig:word}
\end{subfigure}

\begin{subfigure}[b]{0.55\textwidth}
  \centering
  \fbox{\includegraphics[width=\textwidth]{pdf}}
  \caption{由~Word软件生成的~.pdf~格式行内公式}\label{fig:subfig:pdf}
\end{subfigure}
